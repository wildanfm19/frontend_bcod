...
const Cart = () => {
    return(
        <div className="lg:px-14 sm:px-8 px-4 py-10">
            ...
            <div className="border-t-[1.5px] border-slate-200 py-4 flex sm:flex-row smLpx-0 px-2 flex-col sm:justify-between gap-4">
                <div></div>
                <div className="flex text-sm gap-1 flex-col">
                   ...
                   <Link className="flex gap-2 items-center mt-2 text-slate-500" to="/">
                        <MdArrowBack/>
